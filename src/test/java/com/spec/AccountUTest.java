...
//	 */
//	@Test
//	@Parameters({ "50, 100, -30, -20", "40, 50, 0, -10", "0, 0, 0, 0", "30, 10, 10, 10"
//
//	})
//	public void should_return_statement_balance_$1_when_i_did_transaction_with_amount_$2_$3_$4(
//			final double expectedBalance, final BigDecimal amount1, final BigDecimal amount2, final BigDecimal amount3) {
//		final Account account = new Account();
...
//		}
//		assertEquals(0, (account.getBalance().compareTo(BigDecimal.valueOf(expectedBalance))));
//	}
